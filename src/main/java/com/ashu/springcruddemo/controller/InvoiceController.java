package com.ashu.springcruddemo.controller;
...
import com.ashu.springcruddemo.exception.InvoiceNotFoundException;
import com.ashu.springcruddemo.model.Invoice;
import com.ashu.springcruddemo.services.IInvoiceService;
...
public class InvoiceController {
	...
	public String saveInvoice(@ModelAttribute Invoice invoice, Model model) {
		System.out.println("Saving Invoice ... " + invoice.getName() + ", " + invoice.getLocation() + ", " + invoice.getAmount());
